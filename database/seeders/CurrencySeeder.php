...
class CurrencySeeder extends Seeder
{
    ...
    {
        $filepath = dirname(__FILE__) . '/iso_4217_currency_table.csv';
        ...
        if (($handle = fopen($filepath, 'r')) !== false) {
            while (($row = fgetcsv($handle, 1000, "\t")) !== false) {
                ...
                Currency::create([
                    ...
                    'decimal_place' => $row[2],
                    'name_en' => $row[3],
                    'name_hr' => $this->localize($row[0], $row[3]),
                    'used_by' => $row[4],
                ]);
            }
            fclose($handle);
    ...
    /**
     * From https://github.com/umpirsky/currency-list/blob/master/data/hr_HR/currency.php
     */
    public function localize($code, $default)
    {
        $hr_HR = [
            'BRZ' => 'BRZ',
        ...
        return isset($hr_HR[$code]) ? $hr_HR[$code] : $default;
    }
}
